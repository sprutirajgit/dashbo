...
public class StudentRisk {
	static Logger log = LogManager.getLogger(StudentRisk.class);
	@Test(priority=2)
	public void studentAtRisk(Method method) throws InterruptedException {
		System.out.println("\n Welcome \n");
	     ...
	     WebDriverManager.chromedriver().setup();
			...
			Reporter.log( "Maximize the Browser", true );
	         ...
	         driver.findElement(By.xpath("/html/body/div[1]/div/div/div/div[2]/div/div/div[4]/div[1]/div/div/div[1]/div[2]/button")).click();
	        
	         List<WebElement> row = driver.findElements(By.xpath("//*[@id=\"root\"]/div/div/div/div[2]/div/div/div[3]/div/div[2]/div/table/tbody/tr"));
	         System.out.println("The number of Record  is from Portal on Student At risk Filletr "+ row.size());
	         log.info("The number of Record  is from Portal on Student At risk Filletr"+ row.size());
	 		 ...
	 		 driver.findElement(By.xpath("/html/body/div[1]/div[1]/div/div/div[2]/div[3]/form/div[1]/div/input[1]")).sendKeys(" implementations@ken42.spj.playground");
	 			...
	 			Reporter.log("Clear the Extra API On the URI ",true);
	 			 driver.findElement(By.xpath("/html/body/div[2]/form/input[2]")).sendKeys("/services/apexrest/StudentRiskData/");
	 			  log.info("on the api Testing Here We fillter the Student at Risk");
	 			 Reporter.log("on the api Testing Here We fillter Student at Risk ",true);
	 				...
	 				log.info("======================RESPONSE FROM THE API====================");
	 				 ...
	 				 log.info("[\r\n"
	 				 		+ "  {\r\n"
	 				 		+ "    \"url\": \"https://ken426--playground.my.salesforce.com/a1v6D000002dlu6QAA\",\r\n"
	 				 		+ "    \"rollNumber\": \"KEN4201\",\r\n"
	 				 		+ "    \"reason\": \"Fees Not Paid\",\r\n"
	 				 		+ "    \"name\": \"Test Student Record 1\"\r\n"
	 				 		+ "  },\r\n"
	 				 		+ "  {\r\n"
	 				 		+ "    \"url\": \"https://ken426--playground.my.salesforce.com/a1v6D000002dgdGQAQ\",\r\n"
	 				 		+ "    \"rollNumber\": \"KEN4202\",\r\n"
	 				 		+ "    \"reason\": \"fee not paid\",\r\n"
	 				 		+ "    \"name\": \"Test Student Record 2\"\r\n"
	 				 		+ "  },\r\n"
	 				 		+ "  {\r\n"
	 				 		+ "    \"url\": \"https://ken426--playground.my.salesforce.com/a1v6D000002dgdnQAA\",\r\n"
	 				 		+ "    \"rollNumber\": \"KEN4235\",\r\n"
	 				 		+ "    \"reason\": \"Disciplinary Issue\",\r\n"
	 				 		+ "    \"name\": \"Test Student Record 35\"\r\n"
	 				 		+ "  },\r\n"
	 				 		+ "  {\r\n"
	 				 		+ "    \"url\": \"https://ken426--playground.my.salesforce.com/a1v6D000002dgeUQAQ\",\r\n"
	 				 		+ "    \"rollNumber\": \"KEN4278\",\r\n"
	 				 		+ "    \"reason\": \"Fees Not Paid\",\r\n"
	 				 		+ "    \"name\": \"Test Student Record 78\"\r\n"
	 				 		+ "  }\r\n"
	 				 		+ "]");
	 				 log.info("=============Completed===============");
